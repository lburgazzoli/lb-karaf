 ...
 *
 */
public abstract class AbstractManagedService implements ILifeCycle,ManagedService {
    public static final Logger LOGGER = LoggerFactory.getLogger(AbstractManagedService.class);
     ...
     * c-tor
     */
    protected AbstractManagedService(String pid) {
        m_pid = pid;
        m_bundlContext = null;
    }
