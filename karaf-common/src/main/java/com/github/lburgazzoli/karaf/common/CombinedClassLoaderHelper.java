 ...
 *
 */
public class CombinedClassLoaderHelper implements ILifeCycle, BundleListener {
    private static final Logger LOGGER = LoggerFactory.getLogger(CombinedClassLoaderHelper.class);
     ...
     * @param classLoader
     */
    public CombinedClassLoaderHelper(
            BundleContext bundleContext,
            CombinedClassLoader classLoader) {
