 ...
 */
package com.github.lburgazzoli.karaf.common;
...
public class CombinedClassLoader extends ClassLoader {
    public static final Logger LOGGER = LoggerFactory.getLogger(CombinedClassLoader.class);
    ...
    public CombinedClassLoader() {
        this(null,CombinedClassLoader.class.getClassLoader());
    }

    /**
     * c-tor
     */
    public CombinedClassLoader(BundleContext bundleContext) {
     ...
     * @param classLoader the delegate class loader
     */
    public CombinedClassLoader(BundleContext bundleContext, ClassLoader classLoader) {
        super(classLoader);
